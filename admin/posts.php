...
<body>
	...
	<div class="container content">
		...
		<div class="table-div"  style="width: 80%;">
			...
			<?php else: ?>
				<script src="../static/js/posts_filter.js"></script>
				<input type="text" id="myInput" style="width: 90%" placeholder="Search for title.." onkeyup="filterBySearch()">
					...
					<?php foreach ($posts as $key => $post): ?>
						<tr>
							...
							<?php else: ?>
								...
								<?php if ($post['published'] == true): ?>
									<td><span class="fa fa-thumbs-o-up publish-sign"></span></td>
								<?php else: ?>
